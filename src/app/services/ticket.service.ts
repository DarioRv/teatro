...
export class TicketService {
  ...
  private _seed: Ticket[] = [
    ...
    new Ticket(273138, '12345612C', 10, 'l', new Date(), 8),
    new Ticket(380967, '12345698Z', 10, 'l', new Date(), 8),
    new Ticket(412351, '12345678A', 10, 'e', new Date(), 10),
    new Ticket(538581, '12345612C', 10, 'l', new Date(), 8),
    new Ticket(675142, '12345698Z', 10, 'l', new Date(), 8),
    new Ticket(797387, '12345678A', 10, 'e', new Date(), 10),
  ];
